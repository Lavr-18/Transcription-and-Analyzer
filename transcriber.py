    ...
    try:
        ...
        if assign_roles:
            ...
            chat_response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system",
                     "content": "Ты высокоточный эксперт по разделению ролей в телефонных звонках. Твоя цель - идеально разделить диалог на реплики Менеджера и Клиента, строго следуя инструкциям пользователя и не добавляя ничего лишнего."},
