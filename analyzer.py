...
# ОБНОВЛЕНО: Изменено 13 на 14 критериев и добавлена логика для нового критерия.
...
5.  **Уточнение цели покупки (подарок/себе/офис):** 
...
6.  **Пересогласование на основе выявленных потребностей:**
...
7.  **Проговорить особенности позиций:**
...
9.  **Отработка возражения:** (Этот критерий актуален, только если было возражение)
...
12. **Проговорить состав заказа и общую сумму:**
...
13. **Согласовать детали (адрес; сроки доставки):**
...
14. **Проговорить про предоплату по схеме: дедлайн + причина:**
